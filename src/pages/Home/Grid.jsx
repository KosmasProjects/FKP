                ...
                <Container maxW={'1500px'} pb={'20px'}>
                    <HStack justifyContent={'center'} alignItems={'start'} spacing={0}>
                        ...
                        <TextGridComponent title={"Programy miejskie"} />
                            <GridComponent title={"Pomniki Poznania "} image={"https://wspolnasprawa.blob.core.windows.net/wspolnasprawaphotos/pomniki-stary-marych-T75_9128.jpg"} logo={"https://wspolnasprawa.blob.core.windows.net/wspolnasprawaphotos/logopomniki.png"} color={"teal.400"} id={4} onMouseEnter={() => handleMouseEnter('https://wspolnasprawa.blob.core.windows.net/wspolnasprawaphotos/pomniki-stary-marych-T75_9128.jpg')} onMouseLeave={handleMouseLeave} />
                            <GridComponent title={"Ulicznik poznański"} logo={"https://wspolnasprawa.blob.core.windows.net/wspolnasprawaphotos/ULICZNIK_POZNANSKI_logo-pion_CMYK.svg"} color={"green.400"} id={5} onMouseEnter={() => handleMouseEnter('https://wspolnasprawa.blob.core.windows.net/wspolnasprawaphotos/ULICZNIK_POZNANSKI_logo-poziom_CMYK.jpg')} onMouseLeave={handleMouseLeave} />
